...
/*
    ...
    - password: string, required (hashed in backend)
...
const UserSchema = new mongoose.Schema({
  ...
  password: { type: String, required: true }, // hashed in backend
  role: { type: String, default: "customer" } // default role for Part 2
}, { timestamps: true });

// Audit log for user creation
UserSchema.post("save", doc => 
  console.log(`User created: ${doc.fullName}, account: ${doc.accountNumber}`)
);
