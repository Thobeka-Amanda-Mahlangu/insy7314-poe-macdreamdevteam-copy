...
export const log = {
  ...
  // Employee operations (for employee portal)
  employee: {
    created: (employeeId, fullName) => {
      auditLogger.info("EMPLOYEE: Created", {
        type: "employee",
        action: "created",
        employeeId,
        fullName,
    ...
    updated: (employeeId, changes) => {
      auditLogger.info("EMPLOYEE: Updated", {
        type: "employee",
        action: "updated",
        employeeId,
        changes,
    ...
    deleted: (employeeId) => {
      auditLogger.warn("EMPLOYEE: Deleted", {
        type: "employee",
        action: "deleted",
        employeeId,
        timestamp: new Date().toISOString()
